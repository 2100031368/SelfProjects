...
urlpatterns = [
   ...
   path("viewfstudents3/<str:dept>/<str:ay>/<int:yr>/<str:sem>/<str:ct>/<int:fid>/<int:sec>", views.viewfstudents3,name="viewfstudents3"),
   ...
   path("fpostintcc1/<int:cid>/<int:ft>", views.fpostintcc1, name="fpostintcc1"),
   path("fpostintcc2", views.fpostintcc2, name="fpostintcc2"),

   path("fpostint0/<int:sec>/<str:dept>/<str:ctitle>/<int:cid>/<str:ayr>/<int:y>/<str:sm>", views.fpostint0,name="fpostint0"),
   ...
   path("fstuinternals/<int:sid>", views.fstuinternals, name="fstuinternals"),
   path("fstuinternals2/<int:sid>", views.fstuinternals2, name="fstuinternals2"),

   path("fsgpa0/<int:sid>", views.fsgpa0, name="fsgpa0"),

   path("ftmyprofile",views.ftmyprofile, name="ftmyprofile"),
